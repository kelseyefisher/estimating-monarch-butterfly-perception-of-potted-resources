...
summary<-read.csv("1718_trialsummary_1to5dayscaptive.csv", header=TRUE)
names(summary)
...
bear <- subset(summary, select=c("monarchrunid", "distance", "year", "temp", "cloud", "windspeed", "euclidianbearing", "euclidiandistance", "resourcebearing", "windbearing", "firststep", "firstbearing"))
bear<-na.omit(bear)
...
t.test(bear$windspeed~bear$toward)
